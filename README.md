...
|  **Geolocalización** | Integración con Google Maps API para geocodificación de direcciones en Cali |
...
```bash
git clone https://github.com/Raulospp/gotogether.git
...
Raul Guillermo Orobio

Andres Felipe Sarria
...
<div align="center">
  <sub>GoTogether, Computación movil, Universidad Santiago de Cali</sub>
</div>
