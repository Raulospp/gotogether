...
// ── POST /api/horarios — guardar o actualizar ─────────────────────────────────

export async function upsertHorario(req, res, next) {
  try {
...
// ── GET /api/horarios/me — horario propio ─────────────────────────────────────

export async function getMiHorario(req, res, next) {
  try {
